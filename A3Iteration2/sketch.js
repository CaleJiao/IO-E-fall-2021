...
function draw() {
  ...
  let center = createVector(width, height).div(100)
		.add(p5.Vector.fromAngle(millis() / 900, 10))
		.add(p5.Vector.fromAngle(millis() / 300, 300))
	translate(center);
